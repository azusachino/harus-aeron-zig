...
pub const Poller = struct {
    ...
    // LESSON(udp-transport): std.posix.poll blocks until timeout_ms or ≥1 fd has activity. No spinning; let OS scheduler wake us on I/O events. See docs/tutorial/02-data-path/03-udp-transport.md
