...
pub const cluster = struct {
    ...
    pub const aeron_consensus_codecs = @import("cluster/aeron_consensus_codecs.zig");
    pub const aeron_consensus_adapter = @import("cluster/aeron_consensus_adapter.zig");
