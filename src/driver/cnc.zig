...
const CNC_HEADER_SIZE = 128; // END_OF_METADATA_OFFSET — NOT 4096!
const VERSION_OFFSET = 0; // i32
const TO_DRIVER_BUF_LEN_OFFSET = 4; // i32
const TO_CLIENTS_BUF_LEN_OFFSET = 8; // i32
const COUNTERS_META_BUF_LEN_OFFSET = 12; // i32
const COUNTERS_VAL_BUF_LEN_OFFSET = 16; // i32
const ERROR_LOG_BUF_LEN_OFFSET = 20; // i32
const CLIENT_LIVENESS_TIMEOUT_OFFSET = 24; // i64
const START_TIMESTAMP_OFFSET = 32; // i64
const PID_OFFSET = 40; // i64
const FILE_PAGE_SIZE_OFFSET = 48; // i32
...
pub const CncFile = struct {
    ...
    pub fn setDriverHeartbeat(self: *CncFile, epoch_ms: i64) void {
        ...
        const heartbeat_off = CNC_HEADER_SIZE + data_capacity + 640;
