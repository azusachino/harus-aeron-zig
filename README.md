...
- Override if needed: `make setup-upstream-aeron AERON_UPSTREAM_REF=1.50.4`.
...
- Interop jars and upstream test/doc references in this repo are pinned to Aeron `1.50.4`.
